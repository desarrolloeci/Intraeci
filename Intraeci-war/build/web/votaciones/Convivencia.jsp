<%-- 
    ...
    Created on : 5/09/2016, 03:07:08 PM
...
<%
    ...
    if (cedula != null && !cedula.equals("")) {
        ...
        Vector res2 = admin.ConsultaVotoCopasst(cedula);
         if (res2.size()<=0){
            out.println("<center>No se encuentra habilitado para realizar este proceso.</center>");
        }else {
        String copasst = ((String) res2.elementAt(0));%>
<html>
    <head>
        <title>Comité de Convivencia</title>
        ...
        <script language="javascript">
            ...
            alert("Debe seleccionar dos candidatos");
            elemento.checked = false;
            return false;
            }
            } else {
            nombre = new String("P" + <%=total%>);
            console.info(nombre+"   "+document.forms.formulario1[nombre].checked);
            if (numcheckbox != num_opciones && !document.forms.formulario1[nombre].checked) {
            alert("Debe seleccionar dos candidatos");
            return false;
            }
            }
                            ...
                            <table width="600" border="0" align="center">
                                <tr>
                                    <td align="center" valign="middle"><div align="left"><br>
                                            <span class="textocom">Seleccione <font color="#800000">DOS</font> 
                                                candidatos haciendo click en el círculo del <font color="#990000">cuadro 
                                                rojo</font> correspondiente al candidato deseado y presionando 
                                                al final el botón de <font color="#990000">Enviar voto</font>.</span> 
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                        ...
                                        <tr>
                                            <td width="50">
                                                <table border="1" width="28%" bgcolor="#FF0000">
                                                    <tr>
                                                        <td width="100%">
                                                            <p><input  type="checkbox" name="P<%=i%>" value="<%=infocan.elementAt(0)%>" onclick="return comprueba(this, <%=total%>);"></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
