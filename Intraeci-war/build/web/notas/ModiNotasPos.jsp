<%-- 
    Document   : ModiNotasPos
    Created on : 11/05/2011, 09:11:04 AM
    Author     : lrodriguez
--%>
...
<%
    ...
    if(!impre.equals("0"))
        nomboton = "Imprimir";
    Vector asignaturas = profesor.getAsignaturasPos(empleado.getIdProf(), impre);
%>
...
<jsp:include page="encabezado">
	...
	<jsp:param name="doblenc" value="inicio" />
        <jsp:param name="titulo" value="Notas Posgrado" />
</jsp:include>
	...
	<table width="430" border="1" cellspacing="1" bordercolor="#990000" class="textocom">
	  <tr>
            <td height="30"><div align="center"><strong><font color="#990000" size="3">NOTA:</font> Lea cuidadosamente
                <a href="" onclick="window.open('html/ayunotpos.htm','','width=800,height=600, toolbar=yes,scrollbars=yes,location=no,directories=yes,status=yes,menubar=yes,resizable=yes');return false"> AQUI </a>antes
