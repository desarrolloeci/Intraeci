...
<%  try{
        ...
        if ((formato != null) && (formato.equals("excel"))) {
            ...
            response.setHeader("Content-Disposition", "attachment; filename=\"Listasdeclase.xls\"");
...
<html>
    ...
    <body  onload="preloadImg()">
        ...
        if (!((formato != null) && (formato.equals("excel")))) {
            ...
            <tr>
                <td colspan="2"><strong>Periodo Acad&eacute;mico:</strong> <%=periodo%><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Profesor:</strong><%=empleado.getNomProf()%></td>
            </tr>
            <tr>
      ...
      <table width="680" border="1" cellspacing="0" class="textoimpre">
        ...
        <%Vector estudiantes = profesor.getListasClase(periodo,  idasig, codgrupo);
...
<%
                ...
                correo.enviar("Listas de Clase sin correo", e.getMessage());
            }
%>
