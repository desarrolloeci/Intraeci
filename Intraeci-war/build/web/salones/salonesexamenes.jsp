...
<html>
    <head>
        ...
        <script language="JavaScript" src="jscript/solsalonexamen.js"></script>
        ...
        <table width="819" border="0" align="center" cellpadding="0" cellspacing="0" class="textocom">
            <tr>
                <td align="center" valign="top">
                    <form name="form1" method="post" action="ReservasExamenes" onSubmit="return comprueba();" >
                        ...
                        <table width="90%" border="0" cellspacing="0" cellpadding="0" class="textocom">
                            ...
                            <tr>
                                <td colspan="3"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Hora Inicial :</b>
                            ...
                            <tr>
                                <td colspan="3"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#B70404">Hora Final:</font></td>
                            </tr>
                            <tr>
                                <td colspan="3"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Hora
                                        final:</b>
                                        <input type="radio" name="horafin" value="900">9000
