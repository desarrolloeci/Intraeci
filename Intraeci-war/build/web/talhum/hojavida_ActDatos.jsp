...
<html>
    <head>
        ...
        <script language="javascript" type="text/javascript">
            function validarDatos() {
                ...
                if (dir_final.length === 0) {
                    ...
                    document.getElementById("direccion_erp").value = document.getElementById("dir_final").value;
        ...
        <script type="text/javascript">
            ...
            %>alert("La información fue guardada satisfactoriamente, si no la ve reflejada en este formulario, es debido a que primero será validada.");
                    window.location = "../talhum/hojavida_ActDatos.jsp?paramtext=0";
    ...
    <body background="img/fondoblanco.gif" onload="actualizaDep(true);">
        <p class="textocom">&nbsp;</p>
        <form onsubmit="return confirmacion_definitiva()" name="empleadoERP" id="empleadoERP" method="post" action="../ActualizaDatosEmpleadoTempERP">
            <div align="center" id="div_tabla">En esta ventana podra realizar la visualización y edición de la información que ingreso en el formulario anterior pero la cual aun no es visible.
            <br/><strong>
                    ...
                    <div align='left'><br/>   <a style="color: #333333;text-decoration:none;cursor: pointer" target="_blank" data-toggle="collapse" data-target="#informacionemp">Información empleado</a>
                    <div id="informacionemp" class="collapse">
                    <table border="1" class="tabla" id="tabla1" align="center" width="90%">
                        ...
                        <tr><td><strong>Tipo de Empleado</strong></td>
                            ...
                            <td><input disabled="true" type="email" name="email" id="email" value="<%=InfoEmpTemp.e_mail_alt%>"/>
                    ...
                    function actDir() {
                       ...
                       // e = document.getElementById("lissimbolodir");
                        ...
                        <td colspan="3">
                            ...
                            <br>
                            <label for="dir_final">Su dirección es: </label><input type="text" name="dir_final" id="dir_final" maxlength="40" disabled="true" required="" value="<%=InfoEmpTemp.dir_res%>"/> <div hidden="true" id="alertaDir"><font color="red" >La dirección no puede ser tan larga</font></div>
                        ...
                        <tr><td><strong>Celular:</strong></td>
                            <td colspan="3"><input type="number" name="celular" id="celular" required="" maxlength="10" value="<%=InfoEmpTemp.celular%>"/></td>
                        </tr>
                                ...
                                <select id="est_civ" name="est_civ">
                                    <%
                                        for (HashMap est_civ : estadosCivilesERP) {
                                            if(Integer.parseInt(est_civ.get("codigo").toString())==Integer.parseInt(InfoEmpTemp.est_civ_emp)){
                                             %><option selected value="<%=est_civ.get("codigo")%>"><%=est_civ.get("descripcion")%></option><%
                                            }else{
                        ...
                        <tr><td><strong>País Residencia:</strong></td>
                            <td>
                                <select id="pais_res" name="pais_res" onchange="actualizaDep(false);" required="">
                                    <option value="">Seleccione</option>
                                    <%
                                        String paisTemp="";
                                        for (HashMap pais : paisesERP) {
                                            
                                        paisTemp=pais.get("codigo_pais").toString();
                                        
                                             if(paisTemp.equals(InfoEmpTemp.pai_res.trim())){
                                  %><option  selected value="<%=pais.get("codigo_pais")%>"><%=pais.get("descripcion")%></option><%
                                             }else{
                            ...
                            <td>
                                <select id="dep_res" name="dep_res" disabled=""  onchange="actualizaCiu(false);" required="">
                                    <option value="">Seleccione</option>
                                    <%
                        ...
                        function actualizaDep(NuevaCarga){
                            ...
                            if (NuevaCarga){
                                document.getElementById("dep_res").value="<%=InfoEmpTemp.dpt_res%>"
                                actualizaCiu(true);
                            }
                        }
                        
                        function actualizaCiu(NuevaCarga){
                            var opt_paises = document.getElementById("pais_res");
                            var pais_sel = opt_paises.options[opt_paises.selectedIndex].value;
                            var dept_selection = document.getElementById("dep_res");
                            ...
                            if(NuevaCarga){
                                document.getElementById("ciu_res").value="<%=InfoEmpTemp.ciu_res%>";
                            }
                        }
                    </script>
                        </tr>
                        ...
                        <tr><td><strong>Link del CVLAC:</strong></td>
                            <td><input type="text"  maxlength="100" name="cvlac" id="cvlac" value="<%=InfoEmpTemp.usuario_red4%>"/></td>
                            <td><strong>LinkedIn:</strong></td>
                            <td><input type="text"  maxlength="100" name="linkedin" id="linkedin" value="<%=InfoEmpTemp.usuario_red5%>"/></td>
                        </tr>
                        <tr><td><strong>YouTube:</strong></td>
                            <td><input type="text" maxlength="100" name="youtube" id="youtube" value="<%=InfoEmpTemp.usuario_red6%>"/></td>
                            <td><strong>researchGate:</strong></td>
                            <td><input type="text" maxlength="100" name="researchgate" id="researchgate" value="<%=InfoEmpTemp.usuario_red7%>"/></td>
                        </tr>
                        
                    </table>
                        
                        </div><br></div>
                        <hr style="border-color: #990000;margin: 0;margin-right: 10%"> <br>
                           <div align='left'>   <a style="color: #333333;text-decoration:none;cursor: pointer" target="_blank" data-toggle="collapse" data-target="#perfiltotal">Perfil Empleado</a>
                    <div id="perfiltotal" class="collapse">
 <table  border="1" class="tabla" align="center" width="90%"> 
                        ...
                        <tr><td colspan="3"><strong>Membresías (ASCE, IEEE, entre otras):</strong></td>
                            <td><textarea id="membresias" name="membresias" maxlength="255" onchange="cambiaPerfil()"></textarea></td>
                        </tr>
                        <tr><td colspan="3"><strong>Cargos directivos o dirección de proyectos destacados. En el caso de los profesores de cátedra, poner sólo el cargo y el nombre de la empresa actual. Empresas anteriores no:</strong></td>
                            <td><textarea id="cargos_dir" name="cargos_dir" maxlength="255" onchange="cambiaPerfil()"></textarea></td>
                        </tr>
                        <tr><td colspan="3"><strong>Reconocimientos; premios, becas, condecoraciones:</strong></td>
                            <td><textarea id="reconocimientos" name="reconocimientos" maxlength="255" onchange="cambiaPerfil()"></textarea></td>
                        </tr>
                        <tr><td colspan="3"><strong>Perfil Completo:</strong><button type="button" onclick="return switchEditarPerfil()">Editar Perfil</button></td>
                            <td><textarea name="perfil_completo" id="perfil_completo" disabled="" value="<%=InfoEmpTemp.perfil%>" ><%=InfoEmpTemp.perfil%></textarea></td>
                        ...
                        cambiaPerfil();
                         ...
                         <hr style="border-color: #990000;margin: 0;margin-right: 10%"> <br>
                            <div align='left'>   <a style="color: #333333;text-decoration:none;cursor: pointer" target="_blank" data-toggle="collapse" data-target="#ubicaciontotal">Ubicación</a>
                    <div id="ubicaciontotal" class="collapse">
                            <table  border="1" class="tabla" align="center" width="90%"> 
                             <tr>
                            <td colspan="3"><strong>Ubicación (Bloque y oficina):</strong></td>
                            <td><input type="text" name="ubicacion" id="ubicacion" value="<%=InfoEmpTemp.ubicacion%>" required="" maxlength="50"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr><td colspan="3"><strong>Extensión:</strong></td>
                            <td><input type="text"  maxlength="8" name="ext" id="ext" value="<%=InfoEmpTemp.usr_num_ext%>"/></td>
                        </tr>
                        <tr><td colspan="3"><strong>Áreas de Interés:</strong></td>
                            <td>
                                <%
                                    Integer id_intereses = 0;
                                    for (HashMap area : areasInteresERP) {
                                        Boolean inteFlag = false;
                                        for (HashMap inte : InfoEmpTemp.interesesEmpERP) {
                                            if (area.get("codigo").equals(inte.get("id_interes"))) {
                                                inteFlag = true;
                                            }
                                        }
                             ...
                             <hr style="border-color: #990000;margin: 0;margin-right: 10%"> <br>
                    <div align='left'>
                        <a style="color: #333333;text-decoration:none;cursor: pointer" target="_blank" data-toggle="collapse" data-target="#Experiencia">Consultar Experiencia</a>
                    <div id="Experiencia" class="collapse">
                        <iframe align="center" src="../ExperienciaLab" width="100%" height="40%" style="border: none"></iframe>
                    </div><br></div>
                              <hr style="border-color: #990000;margin: 0;margin-right: 10%"> <br>
                    <div align='left'>
                        <a style="color: #333333;text-decoration:none;cursor: pointer" target="_blank" data-toggle="collapse" data-target="#Publicaciones">Consultar Publicaciones</a>
                    <div id="Publicaciones" class="collapse">
                        <iframe align="center" src="../VerPublicaciones" width="100%" height="40%" style="border: none"></iframe>
                    </div><br>
                    </div>
                               <hr style="border-color: #990000;margin: 0;margin-right: 10%"> <br>
                    <div align='left'>
                        <a style="color: #333333;text-decoration:none;cursor: pointer" target="_blank" data-toggle="collapse" data-target="#Idiomas">Consultar Idiomas</a>
                    <div id="Idiomas" class="collapse">
                        <iframe align="center" src="../FormIdiomasERP" width="100%" height="40%" style="border: none"></iframe>
                    </div><br>
                    </div>
                                <hr style="border-color: #990000;margin: 0;margin-right: 10%"> <br>
                    <div align='left'>
                        <a style="color: #333333;text-decoration:none;cursor: pointer" target="_blank" data-toggle="collapse" data-target="#Familiares">Consultar Familiares</a>
                    <div id="Familiares" class="collapse">
                        <iframe align="center" src="../FormFamiliaresERP" width="100%" height="40%" style="border: none"></iframe>
                    </div>
                    </div>
                                <hr style="border-color: #990000;margin: 0;margin-right: 10%"> <br>

<button type="button" onclick="validarDatos()">Guardar Cambios</button>
            </div>
