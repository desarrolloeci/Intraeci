...
Vector infovec = bdadm.getSociedades(empleado.getDocumProf()), tmp;
%>
<html>
<head>
    ...
    <div align="center">
	  <table width="100%" border="1" cellspacing="0" cellpadding="0" class="textocom">
        <tr>
          ...
          <td width="40%" bgcolor="#CCCCCC"><div align="center">Fecha</div></td>
     ...
     if(infovec.size()>0){
        for(int i=0; i<infovec.size(); i++){
            ...
            %>
        <tr>
          <td><div align="center"><a href="VerSociedad?idd=<%=tmp.elementAt(0)%>"><%=tmp.elementAt(1)%></a></div></td>
          <td><div align="center"><%=tmp.elementAt(2)%></div></td>
          <td><div align="center"><a href="GuardaEmpleado?tipo=sociedades&idd=<%=tmp.elementAt(0)%>&idusr=<%=empleado.getDocumProf()%>" onClick="javascript: return preguntar();">Borrar</a></div></td>
        </tr>
        <%}%>
     <%}else{%>
        <tr>
     ...
     <%}%>
	  ...
	  <div align="left"><br>
	      <a href="VerSociedad"><strong>[ Ingresar nueva sociedad ]</strong></a><br>
