...
Vector infovec = bdadm.getIdiomas(empleado.getDocumProf()), tmp;
%>
<html>
<head>
<title>Idiomas</title>
...
<jsp:include page="encabezado">
	...
	<jsp:param name="doblenc" value="inicio" />
        <jsp:param name="titulo" value="Idiomas" />
</jsp:include>
  ...
  <tr class="textocom">
    ...
    <div align="center">
	  <table width="100%" border="1" cellspacing="0" cellpadding="0" class="textocom">
        <tr>
          <td width="80%" bgcolor="#CCCCCC"><div align="center">Nombre</div></td>
     ...
     if(infovec.size()>0){
        for(int i=0; i<infovec.size(); i++){
            ...
            %>
        <tr>
          <td><div align="center"><a href="VerIdioma?idd=<%=tmp.elementAt(0)%>"><%=tmp.elementAt(1)%></a></div></td>
          <td><div align="center"><a href="GuardaEmpleado?tipo=idiomas&idd=<%=tmp.elementAt(0)%>&idusr=<%=empleado.getDocumProf()%>" onClick="javascript: return preguntar();">Borrar</a></div></td>
        </tr>
        <%}%>
     <%}else{%>
        <tr>
     ...
     <%}%>
	  ...
	  <div align="left"><br>
	      <a href="VerIdioma"><strong>[ Ingresar nuevo idioma ]</strong></a><br>
    </div></div></td>
  </tr>
  <tr>
    <td>
