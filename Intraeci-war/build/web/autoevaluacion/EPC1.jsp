...
<SCRIPT LANGUAGE="JavaScript">
    ...
    function comprueba( ){
        ...
        if ( i==18 || i==19 || i==20 || i== 21 || i== 22 || i== 23  || i== 24 || i== 29 || i== 30 ){
...
<p class="Centro" align="center"><strong>Encuesta Profesores de Cátedra</strong></p>

	<form name="form1"  method="post"  onSubmit="return comprueba( );" action="autoevaluacion">
	<input type="hidden" name="total" value="45">
	<input type="hidden" name="idenc" value="132">
  ...
  <table width="98%" border="1" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="6%" align="center">Nada adecuada</td>
    ...
    <tr> 
      ...
      <td width="11%" align="center" height="22">Excelente</td>
      <td width="11%" align="center" height="22">Buena</td>
      <td width="11%" align="center" height="22">Regular</td>
      <td width="11%" align="center" height="22">Mala</td>
      <td width="6%" align="center" height="22">Muy mala</td>
      <td width="6%" align="center" height="22">No aplica</td>
    </tr>
    <tr> 
      <td width="11%" align="center"> 
    ...
    <tr> 
      ...
      <td width="6%" align="center"> 
        <input type="radio" name="P29" value="0">
      </td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td width="6%" align="center">
        <input type="radio" name="P30" value="0">
      </td>
    </tr>
    <tr> 
