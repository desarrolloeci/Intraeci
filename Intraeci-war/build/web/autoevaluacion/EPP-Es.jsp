...
<p class="Centro" align="center"><strong>Encuesta Profesores de Planta-Es</strong></p>

	<form name="form1"  method="post" onSubmit="return comprueba( );" action="autoevaluacion">
	<input type="hidden" name="total" value="54">
	<input type="hidden" name="idenc" value="140">
  ...
  <table width="98%" border="1" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td rowspan="2" width="38%">El proceso de asignaci&oacute;n de tutores para 
        los estudiantes es: (profesores)</td>
    ...
    <tr> 
      ...
      <td rowspan="2" width="38%">Los procesos de autoevaluaci&oacute;n y autorregulaci&oacute;n 
