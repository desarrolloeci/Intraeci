...
<p class="Centro" align="center"><strong>Cuestionario de Entrevista Empleadores</strong></p>

<form name="form1"  method="post"  onSubmit="return comprueba( );" action="autoevaluacion">

    <input type="hidden" name="flag" value="<%=flag%>">
    <input type="hidden" name="total" value="4">
    <input type="hidden" name="idenc" value="138">
  ...
  <table width="98%" border="1" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="11%" align="center" height="11">Totalmente de acuerdo</td>
      <td width="11%" align="center" height="11">De acuerdo</td>
      <td width="11%" align="center" height="11">Parcialmente de acuerdo</td>
      <td width="11%" align="center" height="11">En desacuerdo</td>
      <td width="12%" align="center" height="11" colspan="2">En total desacuerdo</td>
    </tr>
    <tr> 
      <td width="11%" align="center"> 
    ...
    <tr> 
      <td height="20" width="2%">4</td>
      <td width="38%" height="20">El impacto social que el Programa ha ejercido 
        sobre el medio es:</td>
