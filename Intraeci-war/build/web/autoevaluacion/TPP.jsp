...
<p class="Centro" align="center"><strong>Taller Profesores de Planta</strong></p>
  ...
  <table width="98%" border="1" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="12%" align="center">Nada pertinente</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td rowspan="2" width="38%">Las pol&iacute;ticas, normas y procesos para 
        la selecci&oacute;n y admisi&oacute;n de estudiantes es:</td>
      <td width="11%" align="center">Muy efectivo</td>
      ...
      <td width="12%" align="center">Nada efectivos</td>
    </tr>
    <tr>
      <td width="11%" align="center">
    ...
    <tr>
      ...
      <td rowspan="2" width="38%">Las pol&iacute;ticas, normas y procesos para 
        la selecci&oacute;n y admisi&oacute;n de estudiantes se cumplen en grado:</td>
      ...
      <td width="12%" align="center">Muy bajo</td>
    </tr>
    <tr>
      <td width="11%" align="center">
    ...
    <tr>
      ...
      <td rowspan="2" width="38%">El sistema de registro y archivo acad&eacute;mico 
        de los estudiantes es:</td>
      <td width="11%" align="center">Muy efectivo</td>
      <td width="11%" align="center">Efectivos</td>
      <td width="11%" align="center">Medianamente efectivos</td>
      <td width="11%" align="center">Poco efectivos</td>
    ...
    <tr>
      ...
      <td rowspan="2" width="38%">La aplicaci&oacute;n de pol&iacute;ticas institucionales 
        orientadas al mantenimiento de la calidad docente, estabilidad de la planta 
        y renovaci&oacute;n generacional es:</td>
      ...
      <td width="12%" align="center">Nada adecuada</td>
    </tr>
    <tr>
      <td width="11%" align="center">
    ...
    <tr>
      ...
      <td rowspan="2" width="38%"><font color="#000000">La relaci&oacute;n entre 
        el n&uacute;mero de profesores del programa y el cumplimiento de las necesidades 
        y compromisos del mismo es:</font></td>
      <td width="11%" align="center">Muy adecuada</td>
      <td width="11%" align="center">Adecuada</td>
      <td width="11%" align="center">Medianamente adecuada</td>
      <td width="11%" align="center">Poco adecuada</td>
    ...
    <tr>
      ...
      <td width="12%" align="center">En total desacuerdo</td>
    </tr>
    <tr>
      <td width="11%" align="center">
    ...
    <tr>
      ...
      <td rowspan="2" width="38%">La formaci&oacute;n, la experiencia y la producci&oacute;n 
        intelectual de los profesores son coherentes con los contenidos program&aacute;ticos 
        de las asignaturas que est&aacute;n a su cargo.</td>
      <td width="11%" align="center">Totalmente de acuerdo</td>
      <td width="11%" align="center">De acuerdo</td>
      <td width="11%" align="center">Parcialmente de acuerdo</td>
      <td width="11%" align="center">En desacuerdo</td>
    ...
    <tr>
      ...
      <td rowspan="2" width="38%">Existe correspondencia entre el plan de perfeccionamiento 
        docente y las necesidades y objetivos del Programa.</td>
      <td width="11%" align="center">Totalmente de acuerdo</td>
      <td width="11%" align="center">De acuerdo</td>
      <td width="11%" align="center">Parcialmente de acuerdo</td>
      <td width="11%" align="center">En desacuerdo</td>
    ...
    <tr>
      ...
      <td width="12%" align="center">Nada pertinentes</td>
    </tr>
    <tr>
      <td width="11%" align="center">
    ...
    <tr>
      ...
      <td rowspan="2" width="38%">Las propuestas curriculares del programa responden 
        a los lineamientos curriculares institucionales. </td>
      <td width="11%" align="center">Totalmente de acuerdo</td>
      <td width="11%" align="center">De acuerdo</td>
      <td width="11%" align="center">Parcialmente de acuerdo</td>
      <td width="11%" align="center">En desacuerdo</td>
    ...
    <tr>
      ...
      <td rowspan="2" width="38%">Las pol&iacute;ticas para el tratamiento interdisciplinario 
        se aplican en el programa.</td>
      <td width="11%" align="center">Totalmente de acuerdo</td>
      <td width="11%" align="center">De acuerdo</td>
      <td width="11%" align="center">Parcialmente de acuerdo</td>
      <td width="11%" align="center">En desacuerdo</td>
    ...
    <tr>
      ...
      <td rowspan="2" width="38%">Existe coherencia entre los contenidos y objetivos 
        del programa con las competencias del perfil de formaci&oacute;n.</td>
      <td width="11%" align="center">Totalmente de acuerdo</td>
      <td width="11%" align="center">De acuerdo</td>
      <td width="11%" align="center">Parcialmente de acuerdo</td>
      <td width="11%" align="center">En desacuerdo</td>
    ...
    <tr>
      ...
      <td rowspan="2" width="38%">Las pol&iacute;ticas, criterios y procedimientos 
        de investigaci&oacute;n y de apoyo a la investigaci&oacute;n as&iacute; 
        como estrategias que aseguren la implementaci&oacute;n de esta (v.gr. 
        reconocimiento de tiempo a profesores, laboratorios adecuados, financiaci&oacute;n 
        de proyectos, otros) so</td>
      <td width="11%" align="center">Muy claras</td>
      <td width="11%" align="center">Claras</td>
      <td width="11%" align="center">Medianamente claras</td>
      <td width="11%" align="center">Poco claras</td>
      <td width="12%" align="center">Nada claras</td>
    </tr>
    <tr>
      <td width="11%" align="center">
