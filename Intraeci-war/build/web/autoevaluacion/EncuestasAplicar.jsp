...
<html>
    ...
    <body>
        <div class="container">
            ...
            <center>
                <font color="#800000">Tenga en cuenta que su sesión estará activa durante <b>UNA
            ...
            <table width="90%" border="0" height="143" align="center" class="textocom">
                <tr>
                    <td>
                            ...
                            <br><br>
                    <p align="justify">El proceso de autoevaluación Institucional es de carácter participativo, integral, reflexivo, crítico y constructivo, y de acuerdo con el Modelo Integral de Autoevaluación se realiza cada dos años. Con los aportes de todos los miembros de nuestra comunidad, se logrará identificar las fortalezas y oportunidades tanto a nivel institucional, como de los programas académicos que se encuentran adelantando procesos de aseguramiento de la calidad.
                        <br>
                        A continuación, encontrará una serie de afirmaciones sobre temas de interés institucional. Por favor léalas cuidadosamente y seleccione la opción de respuesta que más se ajuste a su opinión. Si usted considera que la afirmación no aplica para su caso o no conoce sobre ese aspecto, seleccione la opción correspondiente. Además, si desea complementar su respuesta puede hacerlo en el espacio disponible ubicado debajo de cada afirmación.
                        <br>
                        Sus respuestas serán tratadas en forma confidencial. 
                        Contamos con su valiosa y decidida participación.
