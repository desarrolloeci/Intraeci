...
<p class="Centro" align="center"><strong>Encuesta Directores de Programa-Es</strong></p>

	<form name="form1"  method="post" onSubmit="return comprueba( );" action="autoevaluacion">
	
  <p> 
    <input type="hidden" name="total" value="4">
    <input type="hidden" name="idenc" value="139">
  ...
  <table width="98%" border="1" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td rowspan="2" width="38%">El apoyo que los tutores ofrecen a los estudiantes 
        es: (directivos)</td>
      <td width="11%" align="center">Muy efectivo</td>
      <td width="11%" align="center">Efectivo</td>
      <td width="11%" align="center">Medianamente efectivo</td>
      <td width="11%" align="center">Poco efectivo</td>
      <td width="6%" align="center">Nada efectivo</td>
