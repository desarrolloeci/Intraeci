...
<% try {
        ...
        if (headerImg == null || headerImg.equals("")) {
            headerImg = "profesores_empleados.jpg";
        }
%>
<%
...
<body bgcolor="#ffffff">
    ...
    <table width="640" border="0" align="center" cellpadding="0" cellspacing="0">
        <img src="img/profesyadministrativos.png" width="819" height="228" border="0" alt="" >
                        ...
                        <div  id="menu2" >
                            <ul>
                                ...
                                <li>
                                    ...
                                    <form target="_blank" class="login" action="https://horus.escuelaing.edu.co/planeacion/" method="post" id="myForm">
    ...
    <td><a href="" onclick="return false;" onMouseOver="MM_swapImage('barmenusup_r2_c11','','img/bg2.png',0)" onMouseOut="MM_swapImgRestore()"><img name="barmenusup_r2_c11" src="img/barmenusup_r2_c11.gif" width="82" height="22" border="0" alt=""></a></td>
        ...
        <table>
            <tr>
                ...
                <td width="214"><div align="right" class="textocom"><font size="1" color="#666666" face="Verdana, Arial, Helvetica, sans-serif"><strong><%=dateString%></strong></font></div></td>
            </tr>
        </table>
    </td>
</tr>
