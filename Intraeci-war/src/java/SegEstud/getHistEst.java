 ...
 */
public class getHistEst extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet getHistEst</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet getHistEst at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (Integer.parseInt((String) access.elementAt(0)) > 0) tipoEmp = Integer.parseInt((String) access.elementAt(1));
            
            Vector ret = admin.getHistConsultasEst(carne, perAcad, tipoEmp);
