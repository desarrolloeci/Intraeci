...
public class EliminarPublicacion extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            emp.EliminarPublicacion(cod_emp,publicacion);
        } catch (Exception ex) {
            Logger.getLogger(EliminarPublicacion.class.getName()).log(Level.SEVERE, null, ex);
        }
        response.sendRedirect("VerPublicaciones?profesor=valido&cod_emp="+request.getParameter("cod_emp").toString().trim());
    }
