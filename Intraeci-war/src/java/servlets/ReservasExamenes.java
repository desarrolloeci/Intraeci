 ...
 * @author lrodriguez
 */
public class ReservasExamenes extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sesion == null) {
            ...
            if (n < i) {
                ...
                Vector consalon = admin.getConSalonExa(rcsal, capac, fec, hora, ndia, horafin, peracad);
                if (consalon.size() > 0) {
                    ...
                    response.sendRedirect("SalonesExa?error=formaerror");
                }
