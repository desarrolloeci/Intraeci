    ...
    <table width="680" border="0" align="left" cellpadding="0" cellspacing="0" class="textoimpre">
      ...
      <table width="680" border="1" align="left" cellspacing="0" class="textoimpre">
        <tr> 
          ...
          <td width="280"> 
            <div align="center"><b>CEDULA</b></div>
          </td>
          <td width="49"> 
       ...
       // Vector estudiantes = profesor.getListasClase("2015-I",  idasig, codgrupo);
        for ( int a=0 ;  a < estudiantes.size() ;  a++ ){
            ...
            String cedula = profesor.getCedulaEst(estudiante.elementAt(6).toString()).elementAt(0).toString();
%>
        <tr> 
          <td width="2">
...
<%
                ...
                correo.enviar("Listas de Clase con correo", e.getMessage());
            }
%>
