...
<SCRIPT LANGUAGE="JavaScript">
    ...
    function comprueba( ){
        for(i=1; i<55; i++){
            ...
            if (i==18 || i==19 || i==20 || i==21 || i==22 || i==23 || i== 24 || i== 25 || i== 26 || i== 27 || i== 28){
...
<form name="form1"  method="post" onSubmit="return comprueba( );" action="autoevaluacion">
  ...
  <table width="98%" border="1" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td rowspan="2" width="38%">Existe correspondencia entre: a) el Proyecto 
        de Formaci&oacute;n del Programa y b) la Misi&oacute;n Institucional y 
        el PEI.</td>
    ...
    <tr> 
      ...
      <td width="11%" align="center" height="20">Excelente</td>
      <td width="11%" align="center" height="20">Buena</td>
      <td width="11%" align="center" height="20">Regular</td>
      <td width="11%" align="center" height="20">Mala</td>
      <td width="6%" align="center" height="20">Muy mala</td>
      <td width="6%" align="center" height="20">No aplica</td>
    </tr>
    <tr> 
      <td width="11%" align="center"> 
    ...
    <tr> 
      ...
      <td rowspan="2" width="38%"> La calidad del apoyo administrativo prestado 
        al programa por la oficina de presupuesto es:</td>
      <td width="11%" align="center">Excelente</td>
      <td width="11%" align="center">Buena</td>
      <td width="11%" align="center">Regular</td>
      <td width="11%" align="center">Mala</td>
    ...
    <tr> 
      ...
      <td rowspan="2" width="38%"> La calidad del apoyo administrativo prestado 
        al programa por la oficina de Comunicaciones es:</td>
      <td width="11%" align="center">Excelente</td>
      <td width="11%" align="center">Buena</td>
      <td width="11%" align="center">Regular</td>
      <td width="11%" align="center">Mala</td>
    ...
    <tr> 
      ...
      <td width="6%" align="center">
        <input type="radio" name="P25" value="0">
      </td>
    </tr>
    <tr> 
      <td rowspan="2" width="2%">26</td>
      <td rowspan="2" width="38%"> La calidad del apoyo administrativo prestado 
        al programa por la Oficina de Desarrollo Institucional es:</td>
      <td width="11%" align="center">Excelente</td>
      <td width="11%" align="center">Buena</td>
      <td width="11%" align="center">Regular</td>
      <td width="11%" align="center">Mala</td>
    ...
    <tr> 
      ...
      <td width="6%" align="center">
        <input type="radio" name="P26" value="0">
      </td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td width="6%" align="center">
        <input type="radio" name="P27" value="0">
      </td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td rowspan="2" width="38%">Los procesos de autoevaluaci&oacute;n y autorregultaci&oacute;n 
        de las actividades acad&eacute;micas del Programa han incidido en el enriquecimiento 
        de su calidad. </td>
      <td width="11%" align="center">Totalmente de acuerdo</td>
      <td width="11%" align="center">De acuerdo</td>
      <td width="11%" align="center">Parcialmente de acuerdo</td>
    ...
    <tr> 
      ...
      <td rowspan="2" width="38%">La capacidad de los laboratorios, talleres y 
        espacios para pr&aacute;ctica (con simuladores, espacios virtuales, adem&aacute;s 
        de laboratorios) para atender el n&uacute;mero de estudiantes del programa 
        es suficiente. </td>
      <td width="11%" align="center">Totalmente de acuerdo</td>
      <td width="11%" align="center">De acuerdo</td>
      <td width="11%" align="center">Parcialmente de acuerdo</td>
    ...
    <tr> 
      ...
      <td rowspan="2" width="38%">Los mecanismos de planeaci&oacute;n, mantenimiento 
        y actualizaci&oacute;n de los equipos de los laboratorios que garanticen 
        el funcionamiento y la sostenibilidad del Programa son adecuados.</td>
      <td width="11%" align="center">Totalmente de acuerdo</td>
      <td width="11%" align="center">De acuerdo</td>
      <td width="11%" align="center">Parcialmente de acuerdo</td>
      <td width="11%" align="center">En desacuerdo</td>
