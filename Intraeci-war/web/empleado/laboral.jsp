...
Vector infovec = bdadm.getExperiencia(empleado.getDocumProf()), tmp;
%>
<html>
<head>
...
<jsp:include page="encabezado">
	...
	<jsp:param name="doblenc" value="inicio" />
        <jsp:param name="titulo" value="Experiencia Laboral" />
</jsp:include>
    ...
    <div align="center">
	  <table width="100%" border="1" cellspacing="0" cellpadding="0" class="textocom">
        <tr>
          ...
          <td width="30%" bgcolor="#CCCCCC"><div align="center">Cargo</div></td>
     ...
     if(infovec.size()>0){
        for(int i=0; i<infovec.size(); i++){
            ...
            %>
        <tr>
          <td><div align="center"><a href="VerLaboral?idd=<%=tmp.elementAt(0)%>"><%=tmp.elementAt(1)%></a></div></td>
          <td><div align="center"><%=tmp.elementAt(2)%></div></td>
          <td><div align="center"><a href="GuardaEmpleado?tipo=laboral&idd=<%=tmp.elementAt(0)%>&idusr=<%=empleado.getDocumProf()%>" onClick="javascript: return preguntar();">Borrar</a></div></td>
        </tr>
        <%}%>
     <%}else{%>
        <tr>
     ...
     <%}%>
	  ...
	  <div align="left"><br>
	      <a href="VerLaboral"><strong>[ Ingresar nueva experiencia laboral]</strong></a><br>
